...
def _chinese_whispers(encoding_list, threshold=0.6, iterations=20):
    ...
    http://alexloveless.co.uk/data/chinese-whispers-graph-clustering-ihttps://pypi.tuna.tsinghua.edu.cn/simple-python/

    Inputs:
        encoding_list: a list of facial encodings from face_recognitiohttps://pypi.tuna.tsinghua.edu.cn/simple
